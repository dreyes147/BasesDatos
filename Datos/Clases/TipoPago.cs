    ...
    public class TipoPago
    {
        ...
        public DataTable Selecccionar(List<Filtro> pFiltros)
        {
            ...
            try
            {
                vSQL += "SELECT ";
                vSQL += "IdTipoPago ";
                vSQL += ",DescripcionTipoPago ";
                vSQL += "FROM dbo.TIPO_PAGO";
        ...
        public void Insertar(Comunes.Estructuras.TipoPago pDatos)
        {
            ...
            try
            {
                vSQL += "INSERT INTO dbo.TIPO_PAGO (IdTipoPago, DescripcionTipoPago) ";
                vSQL += "VALUES(" + pDatos.IdTipoPago.ToString() + ", " + "'" + pDatos.DescripcionTipoPago + "'" + ")";
        ...
        public void Eliminar(List<Filtro> pFiltros)
        {
            ...
            try
            {
                if (pFiltros != null && pFiltros.Count != 0)
                {
                    vSQL += "DELETE FROM dbo.TIPO_PAGO";
                    vSQL += vFiltros.CrearWhere(pFiltros);
                }
                vConnexion.Ejecutar(vSQL, "BASEDATOS");
            }
        ...
        public void Actualizar(Comunes.Estructuras.TipoPago pDatos, List<Filtro> pFiltro)
        {
            ...
            try
            {
                vSQL += "UPDATE dbo.TIPO_PAGO SET " + "IdTipoPago = " + pDatos.IdTipoPago.ToString() + ", " + "DescripcionTipoPago = " + "'" + pDatos.DescripcionTipoPago + "'";
                if (pFiltro != null)
                {
        ...
        public void Actualizar(List<Filtro> pFiltros, List<Campos> pCampos)
        {
            ...
            try
            {
                ...
                vSQL += "UPDATE dbo.TIPO_PAGO" + vQuery;
                vSQL += vFiltros.CrearWhere(pFiltros);
                vConnexion.Ejecutar(vSQL, "BASEDATOS");
            }
            catch (Exception ex)
