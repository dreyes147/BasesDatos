...
namespace Datos.Clases
{
    public class TipoAsiento
    {
        ...
        public void Insertar(Comunes.Estructuras.TipoAsiento pDatos)
        {
            ...
            try
            {
                vSQL += "INSERT INTO dbo.TIPO_ASIENTO (DescripcionTipoAsiento) ";
                vSQL += "VALUES(" + "'" + pDatos.DescripcionTipoAsiento + "'" + ")";
        ...
        public void Actualizar(Comunes.Estructuras.TipoAsiento pDatos, List<Filtro> pFiltro)
        {
            ...
            try
            {
                vSQL += "UPDATE dbo.TIPO_ASIENTO SET " + "DescripcionTipoAsiento = " + "'" + pDatos.DescripcionTipoAsiento + "'";
                if (pFiltro != null)
                {
