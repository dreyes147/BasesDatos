    ...
    public class PersonaNacional
    {
        ...
        public DataTable Selecccionar(List<Filtro> pFiltros)
        {
            ...
            try
            {
                ...
                vSQL += ",IdPersona ";
                vSQL += ",IdTipoPersona ";
                vSQL += "FROM dbo.PERSONA_NACIONAL";
        ...
        public void Insertar(Comunes.Estructuras.PersonaNacional pDatos)
        {
            ...
            try
            {
                vSQL += "INSERT INTO dbo.PERSONA_NACIONAL (Nombre, PrimerApellido, SegundoApellido, FechaNacimiento, IdPersona, IdTipoPersona) ";
                vSQL += "VALUES(" + "'" + pDatos.Nombre + "', " + "'" + pDatos.PrimerApellido + "', " + "'" + pDatos.SegundoApellido + "', " + pDatos.FechaNacimiento.ToString() + ", " + pDatos.IdPersona.ToString() + ", " + pDatos.IdTipoPersona.ToString() + "" + ")";
        ...
        public void Eliminar(List<Filtro> pFiltros)
        {
            ...
            try
            {
                if (pFiltros != null && pFiltros.Count != 0)
                {
                    vSQL += "DELETE FROM dbo.PERSONA_NACIONAL";
                    vSQL += vFiltros.CrearWhere(pFiltros);
                }
                vConnexion.Ejecutar(vSQL, "BASEDATOS");
            }
        ...
        public void Actualizar(Comunes.Estructuras.PersonaNacional pDatos, List<Filtro> pFiltro)
        {
            ...
            try
            {
                vSQL += "UPDATE dbo.PERSONA_NACIONAL SET " + "Nombre = " + "'" + pDatos.Nombre + "', " + "PrimerApellido = " + "'" + pDatos.PrimerApellido + "', " + "SegundoApellido = " + "'" + pDatos.SegundoApellido + "', " + "FechaNacimiento = " + pDatos.FechaNacimiento.ToString() + ", " + "IdPersona = " + pDatos.IdPersona.ToString() + ", " + "IdTipoPersona = " + pDatos.IdTipoPersona.ToString() + "";
                if (pFiltro != null)
                {
        ...
        public void Actualizar(List<Filtro> pFiltros, List<Campos> pCampos)
        {
            ...
            try
            {
                ...
                vSQL += "UPDATE dbo.PERSONA_NACIONAL" + vQuery;
                vSQL += vFiltros.CrearWhere(pFiltros);
                vConnexion.Ejecutar(vSQL, "BASEDATOS");
            }
            catch (Exception ex)
