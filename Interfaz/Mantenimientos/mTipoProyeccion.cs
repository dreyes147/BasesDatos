...
{
    public partial class mTipoProyeccion : Form
    {
        public mTipoProyeccion()
        {
            InitializeComponent();
        }
        ...
        private void CargarVista()
        {
            ...
            Negocio.Clases.TipoProyeccion vPrx = new Negocio.Clases.TipoProyeccion();
            ...
            try
            {
                ...
                {
                    vItem = ltvInformacion.Items.Add(vRow["IdTipoProyeccion"].ToString());
                    vItem.SubItems.Add(vRow["DescripcionTipoProyeccion"].ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        private void mTipoProyeccion_Load(object sender, EventArgs e)
        {
            try
            {
                Inicializar();
        ...
        {
            Comunes.Estructuras.TipoProyeccion vEstructura = new Comunes.Estructuras.TipoProyeccion();
            Negocio.Clases.TipoProyeccion vNegocio = new Negocio.Clases.TipoProyeccion();
            List<Comunes.Filtros.Filtro> vFiltros = new List<Comunes.Filtros.Filtro>();
            try
            {
                if (txtDescripcion.Text.Trim() != string.Empty)
                {
                    ...
                    vEstructura.DescripcionTipoProyeccion = txtDescripcion.Text;
                    switch (vModo)
                    {
                        case "A":
                            vEstructura.IdTipoProyeccion = 0;
                            vNegocio.Insertar(vEstructura);
                            break;
                        case "M":
                            vEstructura.IdTipoProyeccion = Convert.ToInt32(lblId.Text);
                            vFiltros.Add(new Comunes.Filtros.Filtro("IdTipoProyeccion", "=", Convert.ToInt32(lblId.Text)));
