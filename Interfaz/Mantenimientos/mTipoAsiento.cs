...
{
    public partial class mTipoAsiento : Form
    {
        public mTipoAsiento()
        {
            InitializeComponent();
        ...
        private void CargarVista()
        {
            ...
            Negocio.Clases.TipoAsiento vPrx = new Negocio.Clases.TipoAsiento();
            ...
            try
            {
                ...
                {
                    vItem = ltvInformacion.Items.Add(vRow["IdTipoAsiento"].ToString());
                    vItem.SubItems.Add(vRow["DescripcionTipoAsiento"].ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        private void mTipoAsiento_Load(object sender, EventArgs e)
        {
            try
            {
                Inicializar();
        ...
        {
            Comunes.Estructuras.TipoAsiento vEstructura = new Comunes.Estructuras.TipoAsiento();
            Negocio.Clases.TipoAsiento vNegocio = new Negocio.Clases.TipoAsiento();
            List<Comunes.Filtros.Filtro> vFiltros = new List<Comunes.Filtros.Filtro>();
            try
            {
                if (txtDescripcion.Text.Trim() != string.Empty)
                {
                    ...
                    vEstructura.DescripcionTipoAsiento = txtDescripcion.Text;
                    switch (vModo)
                    {
                        case "A":
                            vEstructura.IdTipoAsiento = 0;
                            vNegocio.Insertar(vEstructura);
                            break;
                        case "M":
                            vEstructura.IdTipoAsiento = Convert.ToInt32(lblId.Text);
                            vFiltros.Add(new Comunes.Filtros.Filtro("IdTipoAsiento", "=", Convert.ToInt32(lblId.Text)));
