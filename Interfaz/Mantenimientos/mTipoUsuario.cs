...
{
    public partial class mTipoUsuario : Form
    {
        public mTipoUsuario()
        {
            InitializeComponent();
        ...
        private void CargarVista()
        {
            ...
            Negocio.Clases.TipoUsuario vPrx = new Negocio.Clases.TipoUsuario();
            ...
            try
            {
                ...
                {
                    vItem = ltvInformacion.Items.Add(vRow["IdTipoUsuario"].ToString());
                    vItem.SubItems.Add(vRow["DescripcionTipoUsuario"].ToString());
                }
            }
            catch (Exception ex)
            {
