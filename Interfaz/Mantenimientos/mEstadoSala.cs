...
{
    public partial class mEstadoSala : Form
    {
        public mEstadoSala()
        {
            InitializeComponent();
        ...
        private void CargarVista()
        {
            ...
            Negocio.Clases.EstadoSala vPrx = new Negocio.Clases.EstadoSala();
            ...
            try
            {
                ...
                {
                    vItem = ltvInformacion.Items.Add(vRow["IdEstadoSala"].ToString());
        ...
        private void mEstadoSala_Load(object sender, EventArgs e)
        {
            try
            {
                Inicializar();
        ...
        {
            Comunes.Estructuras.EstadoSala vEstructura = new Comunes.Estructuras.EstadoSala();
            Negocio.Clases.EstadoSala vNegocio = new Negocio.Clases.EstadoSala();
            List<Comunes.Filtros.Filtro> vFiltros = new List<Comunes.Filtros.Filtro>();
            try
            {
                if (txtDescripcion.Text.Trim() != string.Empty)
                {
                    ...
                    {
                        case "A":
                            vEstructura.IdEstadoSala = 0;
                            vNegocio.Insertar(vEstructura);
                            break;
                        case "M":
                            vEstructura.IdEstadoSala = Convert.ToInt32(lblId.Text);
                            vFiltros.Add(new Comunes.Filtros.Filtro("IdEstadoSala", "=", Convert.ToInt32(lblId.Text)));
