...
{
    public partial class mIdioma : Form
    {
        public mIdioma()
        {
            InitializeComponent();
        ...
        private void mIdioma_Load(object sender, EventArgs e)
        {
            try
            {
                Inicializar();
        ...
        {
            Comunes.Estructuras.Idioma vEstructura = new Comunes.Estructuras.Idioma();
            Negocio.Clases.Idioma vNegocio = new Negocio.Clases.Idioma();
            List<Comunes.Filtros.Filtro> vFiltros = new List<Comunes.Filtros.Filtro>();
            try
            {
                if (txtDescripcion.Text.Trim() != string.Empty)
                {
                    ...
                    vEstructura.DescripcionIdioma = txtDescripcion.Text;
                    switch (vModo)
                    {
                        case "A":
                            vEstructura.IdIdioma = 0;
                            vNegocio.Insertar(vEstructura);
                            break;
                        case "M":
                            vEstructura.IdIdioma = Convert.ToInt32(lblId.Text);
                            vFiltros.Add(new Comunes.Filtros.Filtro("IdIdioma", "=", Convert.ToInt32(lblId.Text)));
